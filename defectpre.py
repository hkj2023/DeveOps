...
y_prob = model.predict_proba(X_test)[:,1] if len(model.classes_)==2 else model.predict_proba(X_test)[:,0]
...
with open("outputs/defect_prediction.json","w") as f: json.dump(output,f,indent=2)
